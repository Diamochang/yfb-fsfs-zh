...
> Copyright © 2002, 2007, 2014, 2015 Richard Stallman. 本文在 2002 年首次发表于 GNU 网站 <https://gnu.org>。
...
阻止背叛计算将会需要大量的公民来组织参与。我们需要您的帮助！请支持[设计性缺陷（Defective by Design）运动](https://DefectiveByDesign.org)，这是自由软件基金会反对数字限制管理的运动。

### 补篇

1.  计算机安全领域以另一种方式使用短语“信任计算”——注意不要混淆二者的涵义。

2.  GNU 计划发布了 GNU 隐私卫士（GNU Privacy Guard，简称 GnuPG 或 GPG），这是一款能够实施公钥加密和数字签名的软件，您可以使用它发送安全私密的邮件。您需要认清 GPG 和背叛计算的本质区别，并且知道为何前者是有益的而后者是极度阴险的。
...
[^canyoutrust-1]: 参见我的文章 “We Can Put an End to Word Attachments,” 位于 <https://gnu.org/philosophy/no-word-attachments.html>, 以获知 Word 文档所能导致的一系列问题的描述以及我们关于如何解决它们的一些建议。

[^canyoutrust-2]: 如需获得更多信息，参见 “‘Trusted Computing’ Frequently Asked Questions,” 一文，位于 <https://www.cl.cam.ac.uk/users/rja14/tcpa-faq.html>.
