...
> Copyright © 2001, 2012 Richard Stallman. 本文在 2001 年 6 月 8 日首次发表于《自然》杂志的 Web Debates 论坛。
...
[^push-1]: “MIT Faculty Open Access Policy” 于 2009 年三月 18 日经教学科研人员无记名投票通过，见 [http://libraries.mit.edu/scholarly/mit-open-access/open-access-at-mit/mit-open-access-policy/](http://libraries.mit.edu/scholarly/mit-open-access/open-access-at-mit/mit-open-access-policy/)（目前（2019 年 1 月）该链接已失效，可于 [https://libraries.mit.edu/scholarly/mit-open-access/open-access-policy/](https://libraries.mit.edu/scholarly/mit-open-access/open-access-policy/) 访问到该内容。——译者注）。
