...
> Copyright © 1996–1999，2001–2004，2007–2015 自由软件基金会。本清单在 1996 年首次发表于 GNU 网站 <https://gnu.org>。
...
### 赠送软件（Give Away Software）<!--(pandoc) {#pandoc_words-to-avoid_giveaway}(pandoc)-->
...
请不要使用 PowerPoint 指代任何类型的幻灯片演示文稿。它只是一款特定的用于制作演示文稿的私有软件的名字。为了您的自由，您应该只用自由软件来制作演示文稿。推荐的可选工具包括 <!--(pdf)\TeX\begin{comment} (pdf)-->TeX<!--(pdf) \end{comment}(pdf)--> 的 beamer 类以及 OpenOffice.org（或 LibreOffice——译者注）的 Impress。
