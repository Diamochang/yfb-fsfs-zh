...
> Copyright © 1996–1998, 2001, 2006, 2007, 2009, 2011, 2012, 2014, 2015 自由软件基金会。本文在 1996 年首次发表于 GNU 网站 <https://gnu.org>。
...
一款类 Unix 操作系统由众多程序构成。GNU 操作系统包括所有 GNU 程序包。它还包括很多其他程序包，诸如 X Window 系统以及 <!--(pdf)\TeX\begin{comment} (pdf)-->TeX<!--(pdf) \end{comment}(pdf)-->，它们不是 GNU 软件。
