...
\noindent
本书基于 GNU 自由文档许可证 1.3 版（GNU Free Documentation License 1.3）授权发布，可自由复制和分发，和/或基于 GNU 自由文档许可证 1.3 版或自由软件基金会发布的更高版本，做出修改。本书使用 Markdown 书写，源码地址：\url{https://github.com/Diamochang/yfb-fsfs-zh}。
