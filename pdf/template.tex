...
% 编辑本暂时改用 AR PL SungtiL GB 文鼎PL简报宋以规避字体版权风险。以下注释为 BLUG 的讨论记录。
...
\author{\textbf{[美] 理查德·斯托曼 著}\\
       \textbf{北京 GNU/Linux 用户组\ GNU 网站中文翻译者团队\ 译}
       \textbf{Mike Wang 主编}}
...
\noindent
Copyright \copyright{} 2016-2019 Beijing GNU/Linux User Group <https://beijinglug.club>, 2026 Mike Wang <https://imdchs.rf.gd>.
...
\textbf{本书基于 GNU 自由文档许可证 1.3 版（GNU Free Documentation License 1.3）授权发布，可自由复制和分发，和/或基于 GNU 自由文档许可证 1.3 版或自由软件基金会发布的更高版本，做出修改。本书使用 Markdown 书写，源码地址：\url{https://github.com/Diamochang/yfb-fsfs-zh}。}
\noindent{原书书号：ISBN 978-0-9831592-5-4}
\end{center}
